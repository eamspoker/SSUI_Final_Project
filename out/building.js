...
let textureCubes = [];
let names = ["sunrise", "day", "sunset", "night"];
let texture_index = 1;
names.forEach((name) => {
...
function setColor(object, color, index) {
    if (object.material) {
        if (object.isMesh) {
            // find the index of the mesh based on
            // parsing its name
            let mesh_index = object.name.split("_").length > 3 ?
...
function setBuildingType(building_model, id) {
...
function animate() {
    ...
    if (building_model) {
        ...
        // idx 6-8: scale
        // idx 9: rotation
        let features = (_a = document.getElementById("text_editing").value.split(";")) !== null && _a !== void 0 ? _a : nullError("text_editing");
        ...
        let spin_checkbox = (_b = document.getElementById("spin")) !== null && _b !== void 0 ? _b : nullError("spin");
        ...
        // viewport
        let rotation_slider_y = (_c = document.getElementById("camera_rot_y")) !== null && _c !== void 0 ? _c : nullError("camera_rot_y");
        let rotation_slider_x = (_d = document.getElementById("camera_rot_x")) !== null && _d !== void 0 ? _d : nullError("camera_rot_x");
